// // .
// // const API_KEY = "AIzaSyAv1eb2v6F5l0pxHvQkmRSOobjISk_8yps";
...
function getProblemContext() {
    ...
    // const problemTitle = document.getElementsByClassName('fw-bolder problem_heading fs-4')[0].innerText;
    // const problemDescription = document.getElementsByClassName('coding_desc__pltWY problem_paragraph')[0].innerText;
    const problemDescription = document.getElementsByClassName('coding_desc_container__gdB9M')[0].innerText;
    // const inputFormat=document.getElementsByClassName('coding_input_format__pv9fS problem_paragraph')[0].innerText;
    // const title = problemTitle ? problemTitle.innerText.trim() : "Unknown Problem";
    // const description = problemDescription ? problemDescription.innerText.trim() : "No description available.";
...
sendButton.addEventListener("click", async () => {
  ...
  if (userMessage) {
    ...
    try {
      ...
      // Get Problem Context and AI Response
...
//   const API_KEY = "AIzaSyBV4-gPOOY9G-UhMjbMIYXmvGGgxyKpxyo";
...
//     return "AI: Error processing your request.";
//   }
// }
